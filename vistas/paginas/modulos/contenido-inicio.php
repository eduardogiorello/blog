		...
		<div class="row">
			...
			<?php endforeach ?>
				...
				<div class="container d-none d-md-block">
					...
					<ul class="pagination justify-content-center" totalPaginas="<?= $totalPaginas; ?>" paginaActual="<?php echo $paginaActual; ?>"></ul>
					<!-- total paginas lleva el valor de php para recibirlo en js archivo script linea 96 -->
