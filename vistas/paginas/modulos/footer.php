					...
					<div class="container p-0">
						...
						<div class="d-flex">
							...
							<div class="d-flex flex-column columna1">
								...
								<figure class="p-2 m-0 photo2" vinculo="<?= $categorias[4]['ruta_categoria']; ?>" style="background:url(<?= $categorias[4]['img_categoria']; ?>) ;">
									
									<p class="text-uppercase p-1 p-md-2 p-xl-1 small"><?= $categorias[4]['titulo_categoria']; ?></p>
							...
							<div class="d-flex flex-column flex-fill columna2">
								...
								<div class="d-block d-md-flex">
									...
									<figure class="p-2 m-o flex-fill photo4" vinculo="<?= $categorias[3]['ruta_categoria']; ?>" style="background:url(<?= $categorias[3]['img_categoria']; ?>) ;">
